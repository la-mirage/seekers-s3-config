SandboxVars = {
    ...
    zReV2 = {
        ...
        --  Minimum=0 Maximum=100 Default=30
        TubeOrSyringeOrFlaskSpawnChance = 50,
        -- The option affects the chance of a drop in a SPECIAL ZOMBIES.
        --  Minimum=0 Maximum=100 Default=30
        TongsSpawnChance = 20,
    ...
    HZ = {
        ...
        HazmatSuitBiologicalProtectionValue = 0.8,
    },
    Susceptible = {
